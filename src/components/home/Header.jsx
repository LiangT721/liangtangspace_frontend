...
const Header = () => {
  ...
  const [bgClass, setbgClass] = useState("home__header");
  ...
  useEffect(() => {
    ...
    switch (true) {
      ...
      case offset >= 100 && offset < 1200:
        setbgClass("home__header home__header__blur");
        break;
      case offset >= 1200:
        setbgClass("home__header home__header__hidden home__header__blur");
        break;
      default:
        break;
    }
    ...
    <div className={bgClass}>
      <div className="home__header__logo--container">
        ...
        <input
          ...
          checked={isCheck}
        />
        <label htmlFor="nav-toggle" className="home__header__checkbox__icon" onClick={setChecked}>
          <Logo />
        </label>
      <div className="home__header__nav">
        <ul className="home__header__nav__list">
          <li className="home__header__nav__item">
            <a href="#about" className="home__header__nav__link" onClick={resetChecked}>
              about
            </a>
          </li>
          <li className="home__header__nav__item">
            <a href="#skills" className="home__header__nav__link" onClick={resetChecked}>
              skills
            </a>
          </li>
          <li className="home__header__nav__item">
            <a href="#portfolio" className="home__header__nav__link" onClick={resetChecked}>
              portfolio
            </a>
          </li>
          <li className="home__header__nav__item">
            <a href="#contact" className="home__header__nav__link" onClick={resetChecked}>
              contact
            </a>
          </li>
        </ul>
        <a href="https://liangtangspace.com/api/uploads/docs/LiangTangResume.docx" className="home__header__resume">
